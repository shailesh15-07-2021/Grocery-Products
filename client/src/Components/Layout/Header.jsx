          ...
          <Nav className="navdiv">
            {userResult ? (
              <NavDropdown
                ...
                className="ml-4 my-3 mr-4"
              >
                <NavDropdown.Item className="navbarItemCategories">
                  <Link to="/profile" className="ml-4 my-3 mr-4 navbarItemLink">
                    Profile
                  </Link>
                </NavDropdown.Item>
              ...
              <NavDropdown.Item className="navbarItemCategories">
                <Link className="ml-4 my-3 mr-4 navbarItemLink" to="/login">
                  Login
                </Link>
              </NavDropdown.Item>
            )}
